...
<body>
  ...
  <!-- tentang detail produk yang telah di pilih -->
    ...
    <div class="col-12 col-md-6 mb-5">
      <form action="" method="post" enctype="multipart/form-data">
          ...
          <div>
            ...
            <select name="ketersediaan_stok" id="ketersediaan_stok" class="form-control">
              ...
              <?php 
                  /* mengenali ketersediaan stok dengan car */
      ...
      <?php
            ...
            if($nama=='' || $kategori=='' || $harga==''){
              ...
              /* jika kosong kita kasih warning */
                ...
                if($nama_file!=''){
                      if($image_size > 5000000){
                        ...
                        if($imageFileType != 'jpg' && $imageFileType != 'png' && $imageFileType != 'gif') {
                          ?>
                              <div class="alert alert-warning mt-3" role="alert">File Harus Bertipe JPG dan PNG</div>
                          <?php
                        }
                        else {
                          ...
                          if($queryUpdate){
                            ?>
                                     <div class="alert alert-primary mt-3" role="alert">Produk Berhasil Di Update
                                     </div>
